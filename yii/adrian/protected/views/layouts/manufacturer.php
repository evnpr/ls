...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
         ...
         <a class="brand" href="<?=Yii::app()->homeUrl?>">BubbleHead</a>
           <div class="nav-collapse">
            <ul class="nav">
              <li <?php if($location=='index') echo 'class="active"'; ?>><a href="<?=Yii::app()->homeUrl?>/site/">Home</a></li>
              <li <?php if($location=='head') echo 'class="active"'; ?>><a href="<?=Yii::app()->homeUrl?>/site/mhead">Head</a></li>
              <li <?php if($location=='body') echo 'class="active"'; ?>><a href="<?=Yii::app()->homeUrl?>/site/mbody">Body</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
    ...
    -->
      <!-- Add jQuery library -->
	<script type="text/javascript" src="<?=Yii::app()->baseUrl?>/assets/lib/jquery-1.7.2.min.js"></script>

	<!-- Add mousewheel plugin (this is optional) -->
	<script type="text/javascript" src="<?=Yii::app()->baseUrl?>/assets/lib/jquery.mousewheel-3.0.6.pack.js"></script>

	<!-- Add fancyBox main JS and CSS files -->
	<script type="text/javascript" src="<?=Yii::app()->baseUrl?>/assets/source/jquery.fancybox.js?v=2.0.6"></script>
	<link rel="stylesheet" type="text/css" href="<?=Yii::app()->baseUrl?>/assets/source/jquery.fancybox.css?v=2.0.6" media="screen" />

	<!-- Add Button helper (this is optional) -->
	<link rel="stylesheet" type="text/css" href="<?=Yii::app()->baseUrl?>/assets/source/helpers/jquery.fancybox-buttons.css?v=1.0.2" />
	<script type="text/javascript" src="<?=Yii::app()->baseUrl?>/assets/source/helpers/jquery.fancybox-buttons.js?v=1.0.2"></script>

	<!-- Add Thumbnail helper (this is optional) -->
	<link rel="stylesheet" type="text/css" href="<?=Yii::app()->baseUrl?>/assets/source/helpers/jquery.fancybox-thumbs.css?v=1.0.2" />
	<script type="text/javascript" src="<?=Yii::app()->baseUrl?>/assets/source/helpers/jquery.fancybox-thumbs.js?v=1.0.2"></script>

	<!-- Add Media helper (this is optional) -->
	<script type="text/javascript" src="<?=Yii::app()->baseUrl?>/assets/source/helpers/jquery.fancybox-media.js?v=1.0.0"></script>
